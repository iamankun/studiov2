...
import { Music, Clock, CheckCircle, XCircle, AlertCircle, Edit, MoreVertical } from 'lucide-react';
          ...
          <div className="p-4">
            <div className="flex items-start justify-between mb-2">
              <div className="flex-1 min-w-0">
                <h4 className="font-semibold text-gray-900 truncate">{submission.title}</h4>
                <p className="text-sm text-gray-600 truncate">{submission.artist}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="text-xs text-gray-500">{submission.mainCategory}</span>
            </div>

            <div className="space-y-2 text-xs text-gray-600">
              <div className="flex justify-between">
                <span>Release Date:</span>
                <span>{submission.releaseDate.toLocaleDateString('vi-VN')}</span>
              </div>
              <div className="flex justify-between">
                <span>Tracks:</span>
